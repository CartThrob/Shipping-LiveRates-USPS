# CartThrob Shipping USPS: Build Process
...
2. Update and commit the version number bump
    ...
    * Update `CARTTHROB_SHIPPING_USPS_NAME` constant in `system/user/addons/cartthrob_shipping_usps/addon.setup.php`
...
6. Build CartThrob Shipping USPS ZIP
    * `$ npm run build-addon`
    * Built CartThrob Shipping USPS ZIP files will be added to the `./build` folder
